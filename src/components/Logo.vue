<template>
  <div class="logo-box font-mono text-zinc-600 dark:text-zinc-300 absolute top-6 left-0 text-sm right-0  mx-auto flex items-center justify-center select-none">
    <p class="tracking-widest">{{ word }}</p>
    ...
    <p class="tracking-widest  scale-x-[-1]">{{ word }}</p>
  </div>
</template>
